...
namespace Microsoft.Quantum.Extensions.Oracles
{
    ...
    public class OracleEmulator
    {
        ...
        private static extern void PermuteBasisTable(IntPtr id, uint num_qbits, [In] uint[] qbits, long table_size, [In] long[] permutation_table);
        ...
        private static extern void AdjPermuteBasisTable(IntPtr id, uint num_qbits, [In] uint[] qbits, long table_size, [In] long[] permutation_table);
    }
