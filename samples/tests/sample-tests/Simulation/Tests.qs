...
namespace Microsoft.Quantum.Tests {
    ...
    function SinSquared (theta : Double) : Double {
        return PowD(Sin(theta), 2.0);
    }

    operation AssertExpPreparesKnownState(pauli : Pauli, angle : Double, expected : (Complex, Complex), preparation : (Qubit => Unit)) : Unit {
        using (qubit = Qubit()) {
            preparation(qubit);
            Exp([pauli], angle, [qubit]);
    ...
    operation ExpZKnownStateTest() : Unit {
        // exp{+i π Z / 3} |+〉
        AssertExpPreparesKnownState(PauliZ, PI() / 3.0, (Complex(0.35355339059327384, 0.61237243569579458), Complex(0.35355339059327384, -0.61237243569579458)), H);
    }


    operation ExpXKnownStateTest() : Unit {
        // exp{+i π X / 3} |0〉
        AssertExpPreparesKnownState(PauliX, PI() / 3.0, (Complex(0.5, 0.0), Complex(0.0, 0.86602540378443871)), I);
    }


    operation ExpYKnownStateTest() : Unit {
        // exp{+i π Y / 3} |0〉
        AssertExpPreparesKnownState(PauliY, PI() / 3.0, (Complex(0.5, 0.0), Complex(-0.86602540378443871, 0.0)), I);
    }
    ...
    operation ExpTest () : Unit {
        ...
        using (qubits = Qubit[7]) {
            ...
            AssertMeasurementProbability([PauliZ], [qubits[0]], Zero, 1.0, "Fail [PauliX] [0]", 1E-10);
            ResetAll(qubits);
            Exp([PauliX, PauliI], 1.0 * step, qubits[0 .. 1]);
            Exp([PauliX], -step, [qubits[0]]);
            AssertMeasurementProbability([PauliZ], [qubits[0]], Zero, 1.0, "Fail [PauliX,PauliI] [0,1]", 1E-10);
            ResetAll(qubits);
            Exp([PauliX, PauliX], 1.0 * step, qubits[0 .. 1]);
            AssertMeasurementProbability([PauliZ], [qubits[0]], One, SinSquared(step), "Fail [PauliX,PauliX] [0,1]", 1E-10);
            ResetAll(qubits);
            H(qubits[0]);
            Exp([PauliZ, PauliZ], 1.0 * step, qubits[0 .. 1]);
            H(qubits[0]);
            AssertMeasurementProbability([PauliZ], [qubits[0]], One, SinSquared(step), "Fail [PauliZ,PauliZ] [0,1]", 1E-10);
            ResetAll(qubits);
            H(qubits[0]);
            Exp([PauliZ, PauliZ, PauliZ], 1.0 * step, qubits[0 .. 2]);
            H(qubits[0]);
            AssertMeasurementProbability([PauliZ], [qubits[0]], One, SinSquared(step), "Fail [PauliZ,PauliZ,PauliZ] [0,1,2]", 1E-10);
            ResetAll(qubits);
            H(qubits[0]);
            Exp([PauliZ, PauliZ, PauliZ, PauliX], 1.0 * step, qubits[0 .. 3]);
            H(qubits[0]);
            AssertMeasurementProbability([PauliZ], [qubits[0]], One, SinSquared(step), "Fail [PauliZ,PauliZ,PauliZ,PauliX] [0,1,2]", 1E-10);
            ResetAll(qubits);
            H(qubits[0]);
            Exp([PauliZ, PauliX, PauliZ], 1.0 * step, qubits[0 .. 2]);
            H(qubits[0]);
            AssertMeasurementProbability([PauliZ], [qubits[0]], One, SinSquared(1.0 * step), "Fail [PauliZ,PauliX,PauliZ] [0,1,2]", 1E-10);
            ResetAll(qubits);
            H(qubits[0]);
            Exp([PauliZ], 1.0 * step, qubits[0 .. 0]);
            H(qubits[0]);
            AssertMeasurementProbability([PauliZ], [qubits[0]], One, SinSquared(1.0 * step), "Fail [PauliZ] [0]", 1E-10);
            ResetAll(qubits);
            H(qubits[1]);
            Exp([PauliZ], 1.0 * step, qubits[1 .. 1]);
            H(qubits[1]);
            AssertMeasurementProbability([PauliZ], [qubits[1]], One, SinSquared(1.0 * step), "Fail [PauliZ] [1]", 1E-10);
            ResetAll(qubits);
            H(qubits[0]);
            Exp([PauliZ, PauliX, PauliX], 1.0 * step, qubits[0 .. 2]);
            H(qubits[0]);
            AssertMeasurementProbability([PauliZ], [qubits[0]], One, SinSquared(1.0 * step), "Fail [PauliZ,PauliX,PauliX] [0,1,2]", 1E-10);
            ResetAll(qubits);
            Exp([PauliX, PauliZ, PauliZ], 1.0 * step, qubits[0 .. 2]);
            AssertMeasurementProbability([PauliZ], [qubits[0]], One, SinSquared(1.0 * step), "Fail [PauliX,PauliZ,PauliZ] [0,1,2]", 1E-10);
            ResetAll(qubits);
            Exp([PauliI, PauliX], 1.0 * step, qubits[0 .. 1]);
            Exp([PauliX], -step, [qubits[1]]);
            AssertMeasurementProbability([PauliZ], [qubits[1]], Zero, 1.0, "Fail [PauliI, PauliX] [0,1]", 1E-10);
            ResetAll(qubits);

            //Exp([PauliI, PauliI, PauliX], 2.0 * step, qubits[0..2])
            Exp([PauliX], 1.0 * step, qubits[2 .. 2]);
            AssertMeasurementProbability([PauliZ], [qubits[2]], One, SinSquared(1.0 * step), "Fail [PauliX] [2]", 1E-10);
            ResetAll(qubits);
            Exp([PauliX], 1.0 * step, qubits[0 .. 0]);
            AssertMeasurementProbability([PauliZ], [qubits[0]], One, SinSquared(1.0 * step), "Fail [PauliX] [0]", 1E-10);
            ResetAll(qubits);
            Exp([PauliX, PauliI], 1.0 * step, qubits[0 .. 1]);
            AssertMeasurementProbability([PauliZ], [qubits[0]], One, SinSquared(step), "Fail [PauliX,PauliI] [0,1]", 1E-10);
            ResetAll(qubits);
            Exp([PauliI, PauliX], 1.0 * step, qubits[0 .. 1]);
            AssertMeasurementProbability([PauliZ], [qubits[1]], One, SinSquared(step), "Fail [PauliI,PauliX] [0,1]", 1E-10);
            ResetAll(qubits);
            Exp([PauliY, PauliX], 1.0 * step, Subarray([2, 0], qubits));
            Exp([PauliX, PauliI, PauliY], -1.0 * step, qubits[0 .. 2]);
            AssertMeasurementProbability([PauliZ], [qubits[1]], One, SinSquared(0.0 * step), "Fail [PauliI,PauliX] [0,1]", 1E-10);
            ResetAll(qubits);
            ...
            AssertMeasurementProbability([PauliZ], [qubits[0]], One, SinSquared(0.0 * step), "Fail [PauliI,PauliX,PauliI,PauliY,PauliX,PauliI,PauliZ] [0]", 1E-10);
            AssertMeasurementProbability([PauliZ], [qubits[1]], One, SinSquared(0.0 * step), "Fail [PauliI,PauliX,PauliI,PauliY,PauliX,PauliI,PauliZ] [1]", 1E-10);
            AssertMeasurementProbability([PauliZ], [qubits[2]], One, SinSquared(0.0 * step), "Fail [PauliI,PauliX,PauliI,PauliY,PauliX,PauliI,PauliZ] [2]", 1E-10);
            AssertMeasurementProbability([PauliZ], [qubits[3]], One, SinSquared(0.0 * step), "Fail [PauliI,PauliX,PauliI,PauliY,PauliX,PauliI,PauliZ] [3]", 1E-10);
            AssertMeasurementProbability([PauliZ], [qubits[4]], One, SinSquared(0.0 * step), "Fail [PauliI,PauliX,PauliI,PauliY,PauliX,PauliI,PauliZ] [4]", 1E-10);
            AssertMeasurementProbability([PauliZ], [qubits[5]], One, SinSquared(0.0 * step), "Fail [PauliI,PauliX,PauliI,PauliY,PauliX,PauliI,PauliZ] [5]", 1E-10);
            AssertMeasurementProbability([PauliZ], [qubits[6]], One, SinSquared(0.0 * step), "Fail [PauliI,PauliX,PauliI,PauliY,PauliX,PauliI,PauliZ] [6]", 1E-10);
            ResetAll(qubits);
            H(qubits[0]);
            Exp([PauliZ], IntAsDouble(1), [qubits[0]]);
            Exp([PauliX], IntAsDouble(1), [qubits[0]]);
            AssertMeasurementProbability([PauliZ], [qubits[0]], One, 0.0865891, "Fail Sign H. Z . X", 0.0001);
            ...
            Exp([PauliX], IntAsDouble(1), [qubits[0]]);
            AssertMeasurementProbability([PauliZ, PauliZ], qubits[0 .. 1], One, 0.0865891, "Fail Sign HH. ZZ . X", 0.0001);
            ...
            H(qubits[0]);
            H(qubits[1]);
            AssertMeasurementProbability([PauliZ, PauliZ], qubits[0 .. 1], One, 0.0865891, "Fail Sign  XX . Z . HH", 0.0001);
            ...
            Exp([PauliZ, PauliZ], IntAsDouble(1), qubits[0 .. 1]);
            Exp([PauliX], IntAsDouble(1), [qubits[0]]);
            AssertMeasurementProbability([PauliZ], qubits[0 .. 0], One, 0.789324, "Fail Sign Y. ZZ . X", 0.0001);
            ResetAll(qubits);
        }
    }
