...
- [Hamiltonian/Approximate Energy using Jordan-Wigner transformation generalised.ipynb](Hamiltonian/Approximate%20Energy%20using%20Jordan-Wigner%20transformation.ipynb): Jupyter notebook that runs program on Azure Quantum via IonQ simulator and QPU to estimate the energy of a molecule using dynamic measurement operators.
