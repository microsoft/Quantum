...
1. A brief description of the sample following these guidelines:
  1. Length target of 85 characters (+/- 15 characters at the most)
  1. Should not begin with “This sample” or other boilerplate wording
  1. Should not mention the provider (as that is already noted on the tile)
  1. Should speak in an implied 2nd-person view (“Run a job” preferred over “You can run a job”)
  1. Verbiage should be specific to function and obvious if correlated to other samples in the gallery
  1. Must be approved by a UX designer and PM
