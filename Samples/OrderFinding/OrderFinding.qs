...
namespace Microsoft.Quantum.Samples.OrderFinding {
	...
	/// a superposition over 2ⁿ⁺¹ numbers, which are used to compute the
	/// exponent of the permutation.  The permutation is called n + 1 times
	/// for exponents 2⁰, 2¹, ..., 2ⁿ on the lower n qubits.  For each exponent,
	/// we update the permutation and compute a quantum circuit using reversible
	/// logic synthesis from the namespace `Microsoft.Quantum.Samples.ReversibleLogicSynthesis`.
