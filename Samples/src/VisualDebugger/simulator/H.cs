    ...
    public partial class VisualizationSimulator
    {
        public class SignalRH : Intrinsic.H
        {
            ...
            public override Func<(IQArray<Qubit>, Qubit), QVoid> ControlledBody => (args) =>
            {
                ...
                simulator.AnnounceOperation("Controlled H", (controls.Select(q => q.Id).ToArray(), target.Id)).Wait();
                return QVoid.Instance;
            };
        }
    }
