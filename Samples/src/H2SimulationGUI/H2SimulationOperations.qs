...
namespace Microsoft.Quantum.Samples.H2Simulation {
    ...
    function H2Coeff (idxBondLength : Int) : Double[] {
        ...
        let nBondLengths = 54;
        let bondCoefficients = new Double[][nBondLengths]
            w/ 0 <- [0.5678, -1.4508, 0.6799, 0.0791, 0.0791]
            w/ 1 <- [0.5449, -1.287, 0.6719, 0.0798, 0.0798]
            w/ 2 <- [0.5215, -1.1458, 0.6631, 0.0806, 0.0806]
            w/ 3 <- [0.4982, -1.0226, 0.6537, 0.0815, 0.0815]
            w/ 4 <- [0.4754, -0.9145, 0.6438, 0.0825, 0.0825]
            w/ 5 <- [0.4534, -0.8194, 0.6336, 0.0835, 0.0835]
            w/ 6 <- [0.4325, -0.7355, 0.6233, 0.0846, 0.0846]
            w/ 7 <- [0.4125, -0.6612, 0.6129, 0.0858, 0.0858]
            w/ 8 <- [0.3937, -0.595, 0.6025, 0.087, 0.087]
            w/ 9 <- [0.376, -0.5358, 0.5921, 0.0883, 0.0883]
            w/ 10 <- [0.3593, -0.4826, 0.5818, 0.0896, 0.0896]
            w/ 11 <- [0.3435, -0.4347, 0.5716, 0.091, 0.091]
            w/ 12 <- [0.3288, -0.3915, 0.5616, 0.0925, 0.0925]
            w/ 13 <- [0.3149, -0.3523, 0.5518, 0.0939, 0.0939]
            w/ 14 <- [0.3018, -0.3168, 0.5421, 0.0954, 0.0954]
            w/ 15 <- [0.2895, -0.2845, 0.5327, 0.097, 0.097]
            w/ 16 <- [0.2779, -0.255, 0.5235, 0.0986, 0.0986]
            w/ 17 <- [0.2669, -0.2282, 0.5146, 0.1002, 0.1002]
            w/ 18 <- [0.2565, -0.2036, 0.5059, 0.1018, 0.1018]
            w/ 19 <- [0.2467, -0.181, 0.4974, 0.1034, 0.1034]
            w/ 20 <- [0.2374, -0.1603, 0.4892, 0.105, 0.105]
            w/ 21 <- [0.2286, -0.1413, 0.4812, 0.1067, 0.1067]
            w/ 22 <- [0.2203, -0.1238, 0.4735, 0.1083, 0.1083]
            w/ 23 <- [0.2123, -0.1077, 0.466, 0.11, 0.11]
            w/ 24 <- [0.2048, -0.0929, 0.4588, 0.1116, 0.1116]
            w/ 25 <- [0.1976, -0.0792, 0.4518, 0.1133, 0.1133]
            w/ 26 <- [0.1908, -0.0666, 0.4451, 0.1149, 0.1149]
            w/ 27 <- [0.1843, -0.0549, 0.4386, 0.1165, 0.1165]
            w/ 28 <- [0.1782, -0.0442, 0.4323, 0.1181, 0.1181]
            w/ 29 <- [0.1723, -0.0342, 0.4262, 0.1196, 0.1196]
            w/ 30 <- [0.1667, -0.0251, 0.4204, 0.1211, 0.1211]
            w/ 31 <- [0.1615, -0.0166, 0.4148, 0.1226, 0.1226]
            w/ 32 <- [0.1565, -0.0088, 0.4094, 0.1241, 0.1241]
            w/ 33 <- [0.1517, -0.0015, 0.4042, 0.1256, 0.1256]
            w/ 34 <- [0.1472, 0.0052, 0.3992, 0.127, 0.127]
            w/ 35 <- [0.143, 0.0114, 0.3944, 0.1284, 0.1284]
            w/ 36 <- [0.139, 0.0171, 0.3898, 0.1297, 0.1297]
            w/ 37 <- [0.1352, 0.0223, 0.3853, 0.131, 0.131]
            w/ 38 <- [0.1316, 0.0272, 0.3811, 0.1323, 0.1323]
            w/ 39 <- [0.1282, 0.0317, 0.3769, 0.1335, 0.1335]
            w/ 40 <- [0.1251, 0.0359, 0.373, 0.1347, 0.1347]
            w/ 41 <- [0.1221, 0.0397, 0.3692, 0.1359, 0.1359]
            w/ 42 <- [0.1193, 0.0432, 0.3655, 0.137, 0.137]
            w/ 43 <- [0.1167, 0.0465, 0.362, 0.1381, 0.1381]
            w/ 44 <- [0.1142, 0.0495, 0.3586, 0.1392, 0.1392]
            w/ 45 <- [0.1119, 0.0523, 0.3553, 0.1402, 0.1402]
            w/ 46 <- [0.1098, 0.0549, 0.3521, 0.1412, 0.1412]
            w/ 47 <- [0.1078, 0.0572, 0.3491, 0.1422, 0.1422]
            w/ 48 <- [0.1059, 0.0594, 0.3461, 0.1432, 0.1432]
            w/ 49 <- [0.1042, 0.0614, 0.3433, 0.1441, 0.1441]
            w/ 50 <- [0.1026, 0.0632, 0.3406, 0.145, 0.145]
            w/ 51 <- [0.1011, 0.0649, 0.3379, 0.1458, 0.1458]
            w/ 52 <- [0.0997, 0.0665, 0.3354, 0.1467, 0.1467]
            w/ 53 <- [0.0984, 0.0679, 0.3329, 0.1475, 0.1475];
