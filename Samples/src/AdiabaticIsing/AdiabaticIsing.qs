...
namespace Microsoft.Quantum.Samples.Ising {
    ...
    /// Hamiltonian H(s) when s is varied uniformly between 0 and 1 over Time
    /// `adiabaticTime`.
    function IsingAdiabaticEvolutionBuiltIn (nSites : Int, adiabaticTime : Double, trotterStepSize : Double, trotterOrder : Int, hXCoupling : (Int -> Double), jCoupling : (Int -> Double)) : (Qubit[] => Unit : Adjoint, Controlled) {
